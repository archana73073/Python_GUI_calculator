...
FONT = ('Arial', 12) #define fint and font size

#define calculator button names
...
class CalcPage():
    def __init__(self, master):
        self.master = master
        self.calc_flag = False  #check if last action was calculation
        self.initUI()  #initialize UI

    def initUI(self):
        '''initialize user interface'''
        
        #entery box to show result
    ...
    def create_buttons(self, click_method, names=buttons_name, cols=4):
        '''create buttons and bind click event'''
